...
const EditCar = () => {
  ...
  const handleEditCarDetails = async () => {
      ...
      <div className='flex justify-between h-full'>
        ...
        <div className='bg-blue-gray-50 w-full lg:w-4/5 flex flex-col items-center min-h-max min-w-max overflow-y-scroll py-5'>
            <form className="flex flex-col gap-2 items-center">
                <Typography variant="h4" className="mt-2">Edit Car Details</Typography>
                ...
                <Button color="red" onClick={handleEditCarDetails}>UPLOAD</Button>
                </div>
            </form>
        </div>
      </div>
